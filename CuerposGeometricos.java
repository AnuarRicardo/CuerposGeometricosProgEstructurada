...
public class CuerposGeometricos {
    public static void main(String[] args) throws Exception {
        ...
        int  cantidadlados, altura;
        double longitud, area, volumen, areabasemayor, areabasemenor, areabase, base;
        double radio, generatriz, perimetrobase,  areaLateral, numeros, profundidad;
        double apotema, apotemaB, apotemaP, arealateral, areaTotal, radiomayor, diagonal;
        double perimetrobasemayor, perimetrobasemenor, apotemabase, apotemapiramide;
        ...
        System.out.println("z) calcular Tronco piramide");
